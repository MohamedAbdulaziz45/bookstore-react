        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MemeberSince = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsFeatured = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    FeaturedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsEditorsPick = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    EditorsPickAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    AuthorId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ReviewId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ReviewText = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: false),
